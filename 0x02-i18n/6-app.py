...
def get_locale() -> str:
    ...
    if g.user:
        ...
        return locale if locale in app.config['LANGUAGES'] else 'fr'

    # Locale from request header
    locale_header = request.header.get('locale')
    if locale_header:
        return locale_header if locale in app.config['LANGUAGES'] else 'fr'
